...
export const OrderEditModal: React.FC<OrderEditModalProps> = ({
  ...
  const handleSave = () => {
    ...
    const updatedData: Partial<Pedido> = {
      ...
      punto_referencia: tipoDespacho === 'delivery' ? puntoReferencia.trim() || undefined : undefined,
      maps_url: tipoDespacho === 'delivery' ? mapsUrl.trim() || undefined : undefined,
      repartidor_nombre: tipoDespacho === 'delivery' ? repartidorNombre.trim() || undefined : undefined,
      repartidor_telefono: tipoDespacho === 'delivery' ? repartidorTelefono.trim() || undefined : undefined,
